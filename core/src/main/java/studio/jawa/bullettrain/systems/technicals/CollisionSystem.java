...
public class CollisionSystem extends EntitySystem {
    ...
    public void update(float deltaTime) {
        ...
        // Player collision bounds (smaller than visual for better feel)
    ...
    private void destroyObject(Entity object, BaseObjectComponent objectComp) {
        ...
        // TODO: Add explosion particles, sound effects, or damage to nearby objects
    }
    ...
    private void resolveCollision(TransformComponent playerTransform, 
        ...
        // Determine which axis has smaller overlap (push on that axis)
